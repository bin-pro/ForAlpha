...
@Getter
public enum Quiz {
    QUIZ_1("주식 시장에서 주식의 가격은 수요와 공급에 의해 결정된다.",
            "O",
            "주식 시장에서 주식의 가격은 주식을 사고 팔려는 투자자들의 수요와 공급에 따라 변동됩니다.",
            5),
    ...
    QUIZ_3("주식투자에서 '다이버시피케이션'은 여러 종목에 투자하여 투자 위험을 분산시키는 전략이다.",
            "O",
            "정답입니다. 포트폴리오를 다양한 종목으로 구성하여 투자 위험을 분산시키는 것이 중요합니다.",
            4),

    QUIZ_4("P/E 비율이 높은 주식은 대체로 저평가된 주식이라고 볼 수 있다.",
            "X",
            "P/E 비율이 높다는 것은 주가가 순이익에 비해 상대적으로 높다는 의미이므로, 저평가된 주식이라고 볼 수는 없습니다.",
            2),
    ...
    QUIZ_6("주식 시장에서 '풋 옵션'은 주식 가격이 상승할 것을 기대하는 투자자에게 유리하다.",
            "X",
            "정답입니다. 풋 옵션은 주식 가격이 하락할 것을 예상하는 투자자에게 유리한 옵션입니다.",
            3),
    ...
    QUIZ_14("'주가 수익비율(P/E ratio)'은 주식 시장에서 어떤 기업이 가치 있는 투자 대상인지를 판단하는 데 사용된다.",
            "O",
            "정답입니다. P/E 비율은 기업의 주가를 이익으로 나눈 비율로, 투자 가치를 판단하는 데 활용됩니다.",
            4),
    ...
    Quiz(String question, String answer, String explanation, int point) {
